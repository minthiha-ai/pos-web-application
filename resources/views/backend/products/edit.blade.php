...
@section('content')
    <div class="p-5">
        <div class="product_create">
            ...
            <form action="{{route('product.update', $product->id)}}" id="category_store" method="POST" class="create_form px-4" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-6">
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" autocomplete="off" name="name" value="{{$product->name}}">
                        </div>
                    ...
                    <div class="col-6">
                        <div class="mb-4">
                            ...
                            <input type="text" id="barcode" autocomplete="off" name="barcode" placeholder="Optional" value="{{$product->barcode}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="mb-4">
                            ...
                            <input type="number" id="stock" autocomplete="off" name="stock" value="{{$product->in_stock}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="price" autocomplete="off" name="price" value="{{$product->price}}">
                </div>
